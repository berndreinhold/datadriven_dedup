...
class duplicates_pairwise():
    ...
    def __init__(self, config_filename : str, config_path : str):
        ...
        IO_json = json.load(f)
        self.json_input = IO_json["duplicates"]["input"]
        self.json_output = IO_json["duplicates"]["output"]

        self.outfilename = f"duplicates_{dataset[0]}_{dataset[1]}.csv"

        self.df = {}
        for ds in self.json_input.keys():
